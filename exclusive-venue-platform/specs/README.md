...
- `0002-ai-concierge/`, `0003-landlord-portal/`, `0004-supplier-marketplace/` — populate the week before that product's build starts (Weeks 5–6), same order as the Sprint Board. Do not populate all four on day 1.
